...
return array(
		// 数据库配置
        'DB_TYPE'   => 'mysql', // 数据库类型
        'DB_HOST'   => '123.207.34.29', // 服务器地址
        'DB_NAME'   => 'daziran', // 数据库名 daziran
        'DB_USER'   => 'daziran', // 用户名 daziran
        'DB_PWD'    => 'ccxxdaziran',  // 密码 ccxxdaziran'
        'DB_PORT'   => '56333', // 端口 56333
		...
		// 系统数据加密设置
		'DATA_AUTH_KEY' => '~[hZ=pE#`%Ag!/<e8C&kK^{Y}yT)37.Lu-Q2t@lU', // 默认数据加密KEY

...
class WxPayTransfers extends WxPayDataBase{
	...
	* OPTION_CHECK：针对已实名认证的用户才校验真实姓名（未实名认证用户不校验，可以转账成功）(默认值 )
	**/
	public function SetCheck_name($value="OPTION_CHECK")
	{

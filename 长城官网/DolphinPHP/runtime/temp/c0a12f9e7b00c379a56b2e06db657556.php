<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:62:"E:\WWW\DolphinPHP/application/ccxx/view/admin/index\index.html";i:1506751903;s:52:"E:\WWW\DolphinPHP/application/admin/view/layout.html";i:1505546614;s:46:"./application/common/builder/aside/layout.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/recent.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/online.html";i:1489042525;s:53:"./application/common/builder/aside/blocks/switch.html";i:1489042525;}*/ ?>
<!DOCTYPE html>
...
<div class="row">
    <div class="col-sm-6 col-md-6">
        <a class="block block-link-hover3 text-center" href="<?php echo url('news/index'); ?>">
            <div class="block-content block-content-full">
                <div class="h1 font-w700 text-primary" data-toggle="countTo" data-to="<?php echo (isset($newscount) && ($newscount !== '')?$newscount:0); ?>"></div>
            </div>
            <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">新闻</div>
        </a>
    </div>
    <div class="col-sm-6 col-md-6">
        <a class="block block-link-hover3 text-center" href="<?php echo url('demand/index'); ?>">
            <div class="block-content block-content-full">
                <div class="h1 font-w700 text-success" data-toggle="countTo" data-to="<?php echo (isset($demandcount) && ($demandcount !== '')?$demandcount:0); ?>"></div>
            </div>
            <div class="block-content block-content-full block-content-mini bg-gray-lighter text-muted font-w600">需求</div>
        </a>
    </div>
            ...
            <div class="block-content">
                <div class="row">
                    <div class="col-xs-6 col-sm-6 col-lg-6">
                        <a class="block block-link-hover3 text-center" href="<?php echo url('news/add'); ?>">
                            <div class="block-content block-content-full">
                                <i class="fa fa-plus fa-3x text-muted"></i>
                                <div class="font-w600 push-15-t">发布新闻</div>
                            </div>
                        </a>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-lg-6">
                        <a class="block block-link-hover3 text-center" href="<?php echo url('demand/index'); ?>">
                            <div class="block-content block-content-full">
                                ...
                                <div class="font-w600 push-15-t">查看需求</div>
                            </div>
                        </a>
                    </div>
                </div>
